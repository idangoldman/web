...
**The New Plan**, separate the website code from the application code and move the website code to the same one the blog is using. [Jekyll](https://jekyllrb.com/), the codebase the blog is using if you were wondering.
