...
Link to my [GitHub page](https://github.com/idangoldman) and [LinkedIn profile](https://linkedin.com/in/idangoldman/).
...
Swear to god I'm not cursing! CMSs are your typical content management systems like `WordPress`, `Ghost`, `Drupal` and SSG are [Static Site Generators](https://www.staticgen.com/about) architectural concept that making a comeback!
...
On the SSG side, I'm most experienced with `Jekyll` and know a bit about `Middleman` and `Gatsby`. This very website is built with `Jekyll`, [check the code](https://github.com/idangoldman/idan.goldman.work).
...
### StaticPage ([GitHub](https://github.com/idangoldman?tab=repositories&q=StaticPage))
...
### ToDoin ([GitHub](https://github.com/idangoldman?tab=repositories&q=todo))
...
### Feature ([GitHub](https://github.com/idangoldman/feature))
