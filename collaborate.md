...
- **Schedule a talk**: [Pick a time slot](https://cal.com/idangoldman) and let's figure out if we're a good match.
...
_Have a question about a technical approach or need a second opinion on an architectural decision? I'm happy to provide quick feedback even if we don't end up working together formally._
